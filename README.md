# SPRING_Hibernate_Projects
There are spring hibernate learning projects for learning.
* Book Store here is where you can add books to cart. Delete books from cart and browse the books aswell.
* Movie Store here is where you can add movies into the database and then can browse mocies from database.
